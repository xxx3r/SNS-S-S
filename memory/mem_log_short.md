...
Current Step: Propagate the first complete package conductance budget and a declared BOL/EOL emissivity range through the 30-minute shadow model.
...
- The first geometry-closed package screening budget now includes supports, battery leads, PV flex traces, adhesive bonds, feedthroughs, and PCM containment.
...
- Feed conservative package conductance 1.69575e-4 W/K and a declared BOL/EOL emissivity range into the mass-admissible 30-minute shadow model; record whether any survivor remains before changing node size or architecture.
