...
[S0027 | 2026-07-23] QST-STOR-0002 propagated the conservative package conductance through 24 BOL/EOL emissivity and mass-admissible PCM cases for a favorable 30-minute eclipse. Result: 0/24 thermal or combined passes and 24/24 electrical passes; even the optimistic emissivity 0.10 target produced 0/6 passes. The declared 10 mm packaged-shadow branch is falsified, shifting the next move from parameter polishing to a matched comparison of seed growth, mission-duty change, and host assistance. A=1.0∠-45°|w_ext=0.0. Tags: 3.0 storage, 5.0 materials, 0.2 tooling

[S0028 | 2026-07-24] QST-STOR-0002 compared three bounded escape routes after the packaged 10 mm falsifier. Regression-tested first grid survivors are a 15 mm seed, a 15-minute maximum eclipse, or 80 mW host-supplied thermostatic heat. The 15-minute duty route is the smallest conceptual change but requires mission-geometry evidence; 15 mm remains conditional on a new package budget, while host assistance makes the mote dependent during eclipse. A=1.0∠-30°|w_ext=0.0. Tags: 3.0 storage, 1.0 mission geometry, 0.2 tooling

[S0029 | 2026-07-25] QST-STOR-0002 connected the 15-minute thermal escape boundary to explicit mission geometry. Surface-fixed deployment meets it only for selected targets rotating in 30 minutes or less; none of five declared passive circular-orbit cases passes; active sunward hosted standoff conditionally removes occultation but adds navigation, propulsion, fault-tolerance, and host-service dependencies. A=1.0∠-20°|w_ext=0.0. Tags: 3.0 storage, 1.0 mission geometry, 2.1 architecture, 0.2 tooling
